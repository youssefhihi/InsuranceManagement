...
<div class="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-md">
    ...
    <div id="contractForm" class="mt-6 hidden">
        ...
        <form action="${pageContext.request.contextPath}/contract" method="post" enctype="multipart/form-data" class="space-y-4">
            <div>
            ...
            <div>
                ...
                <input type="file"  multiple id="document" name="document" required class="mt-1 p-2 border border-gray-300 rounded-md w-full">
            </div>
